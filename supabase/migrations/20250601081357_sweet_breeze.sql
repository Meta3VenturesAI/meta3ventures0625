...
DROP POLICY IF EXISTS "Public users can insert page views" ON page_views;
...
-- Allow public access for inserting page views
CREATE POLICY "Public users can insert page views"
  ON page_views
  FOR INSERT
  TO public
  WITH CHECK (true);
